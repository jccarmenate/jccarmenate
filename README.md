...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=24&pause=1000&color=58A6FF&center=true&vCenter=true&width=650&lines=Hi%2C+I'm+Juan+Carlos+%F0%9F%91%8B;CS+Student+%40+University+of+Havana;Building+agentic+AI+systems%2C+full-stack+apps" alt="Typing SVG" />
...
| [**hulk-ide**](https://github.com/jccarmenate/hulk-ide) | A full IDE for a self-designed, statically-typed language: a from-scratch Rust compiler (hand-written lexer/LL(1) parser, 5-pass semantic analyzer with bidirectional type inference, an LLVM 17 backend emitting vtables/itables, a hybrid ref-counting + mark-sweep GC) plus a Language Server and VS Code extension — live diagnostics, hover, go-to-definition, completion, and run. 237 tests across the workspace. | Rust · LLVM 17 · TypeScript · LSP |
